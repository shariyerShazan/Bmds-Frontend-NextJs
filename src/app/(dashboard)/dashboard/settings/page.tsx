...
import { useChangeEmailMutation, useChangePasswordMutation, useLazyGetMeQuery, useUpdateNameMutation } from '@/redux/api/authApi';
...
import { AlertTriangle, KeyRound, Lock, Mail, Pencil, ShieldCheck, UserRound, UsersRound } from 'lucide-react';
...
export default function SettingsPage() {
    ...
    const handleEmailSubmit = async (values: { newEmail: string; password: string }) => {
        try {
    ...
    const displayName = (user?.role === 'ADMIN' ? user?.admin?.fullName : user?.employee?.fullName) || user?.username || '—';
                    ...
                    <div className="flex items-end gap-5">
                        ...
                        <div className="pb-2 min-w-0">
                            ...
                            <span className="inline-flex items-center gap-1 mt-1 px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#272877]/10 text-[#272877]">
                                <ShieldCheck size={12} /> {user?.role === 'ADMIN' ? 'Administrator' : 'Employee'}
                            </span>
                        </div>
                    </div>
                    ...
                    <div className="mt-8 grid sm:grid-cols-2 gap-4">
                        ...
                        <div className="group flex items-center gap-3.5 bg-gray-50 dark:bg-[#1f1f1f] hover:bg-gray-100/80 dark:hover:bg-[#2c2c2c] rounded-xl px-4 py-3.5 transition-colors">
                            <div className="w-9 h-9 rounded-lg bg-[#272877]/10 flex items-center justify-center shrink-0">
                                <UserRound size={17} className="text-[#272877] dark:text-[#6e6fe4]" />
                            </div>
                            <div className="min-w-0 flex-1">
                                <p className="text-[11px] uppercase tracking-wider text-gray-400 dark:text-gray-500 font-semibold transition-colors">Full Name</p>
                                <p className="text-sm font-medium text-gray-900 dark:text-white truncate transition-colors">{displayName}</p>
                            </div>
                            <button
                                onClick={() => {
                                    nameForm.setFieldsValue({ fullName: displayName !== '—' ? displayName : '' });
                        ...
                        <div className="group flex items-center gap-3.5 bg-gray-50 dark:bg-[#1f1f1f] hover:bg-gray-100/80 dark:hover:bg-[#2c2c2c] rounded-xl px-4 py-3.5 transition-colors">
                            <div className="w-9 h-9 rounded-lg bg-[#272877]/10 flex items-center justify-center shrink-0">
                                <Mail size={17} className="text-[#272877] dark:text-[#6e6fe4]" />
                            </div>
                            <div className="min-w-0 flex-1">
                                <p className="text-[11px] uppercase tracking-wider text-gray-400 dark:text-gray-500 font-semibold transition-colors">Email Address</p>
                                <p className="text-sm font-medium text-gray-900 dark:text-white truncate transition-colors">{displayEmail}</p>
                            </div>
                            <button
                                onClick={() => {
                                    emailForm.resetFields();
                ...
                <div className="bg-white dark:bg-[#141414] rounded-2xl border border-gray-100 dark:border-white/10 shadow-[0_1px_3px_rgba(0,0,0,0.04),0_6px_24px_rgba(0,0,0,0.03)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.3)] overflow-hidden transition-colors">
                    <div className="px-6 sm:px-8 pt-7 pb-5 border-b border-gray-100 dark:border-[#303030] flex items-center gap-3 transition-colors">
                        <div className="w-9 h-9 rounded-lg bg-blue-50 dark:bg-blue-500/10 flex items-center justify-center transition-colors">
                            <UserRound size={17} className="text-blue-600 dark:text-blue-400" />
                        </div>
                        <div>
                            <h3 className="text-base font-semibold text-gray-900 dark:text-white transition-colors">Update Name</h3>
                            <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5 transition-colors">Change your display name</p>
                        </div>
                    </div>
                    ...
                    <div className="px-6 sm:px-8 py-7">
                        ...
                        >
                            <Form.Item
                                label={<span className="text-gray-600 dark:text-gray-300 font-medium text-sm transition-colors">Full Name</span>}
                                name="fullName"
                                rules={[
                            ...
                            >
                                <Input
                                    prefix={<UserRound size={15} className="text-gray-400 dark:text-gray-500 mr-1.5" />}
            ...
            {isEditingEmail && (
                <div className="bg-white dark:bg-[#141414] rounded-2xl border border-gray-100 dark:border-white/10 shadow-[0_1px_3px_rgba(0,0,0,0.04),0_6px_24px_rgba(0,0,0,0.03)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.3)] overflow-hidden transition-colors">
                    <div className="px-6 sm:px-8 pt-7 pb-5 border-b border-gray-100 dark:border-[#303030] flex items-center gap-3 transition-colors">
                        ...
                        <div>
                            <h3 className="text-base font-semibold text-gray-900 dark:text-white transition-colors">Change Email</h3>
                            <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5 transition-colors">Update your email address (requires password confirmation)</p>
                        </div>
                    </div>
                    ...
                    <div className="px-6 sm:px-8 py-7">
                        ...
                        >
                            <Form.Item
                                label={<span className="text-gray-600 dark:text-gray-300 font-medium text-sm transition-colors">New Email</span>}
                                name="newEmail"
                                rules={[
                            ...
                            >
                                <Input
                                    prefix={<Mail size={15} className="text-gray-400 dark:text-gray-500 mr-1.5" />}
                            ...
                            <Form.Item
                                label={<span className="text-gray-600 dark:text-gray-300 font-medium text-sm transition-colors">Current Password</span>}
                                name="password"
                                rules={[{ required: true, message: 'Please enter your password for verification' }]}
                            >
                                <Input.Password
                                    prefix={<Lock size={15} className="text-gray-400 dark:text-gray-500 mr-1.5" />}
            ...
            <div className="bg-white dark:bg-[#141414] rounded-2xl border border-gray-100 dark:border-white/10 shadow-[0_1px_3px_rgba(0,0,0,0.04),0_6px_24px_rgba(0,0,0,0.03)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.3)] overflow-hidden transition-colors">
                ...
                <div className="px-6 sm:px-8 pt-7 pb-5 border-b border-gray-100 dark:border-[#303030] flex items-center gap-3 transition-colors">
                    <div className="w-9 h-9 rounded-lg bg-amber-50 dark:bg-amber-500/10 flex items-center justify-center transition-colors">
                        <KeyRound size={17} className="text-amber-600 dark:text-amber-500" />
                    </div>
                    <div>
                        <h3 className="text-base font-semibold text-gray-900 dark:text-white transition-colors">Change Password</h3>
                        <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5 transition-colors">Update your password to keep your account secure</p>
                    </div>
                </div>
                ...
                <div className="px-6 sm:px-8 py-7">
                    ...
                    >
                        ...
                        <Form.Item
                            label={<span className="text-gray-600 dark:text-gray-300 font-medium text-sm transition-colors">New Password</span>}
                            name="newPassword"
                            rules={[
                        ...
                        <Form.Item
                            label={<span className="text-gray-600 dark:text-gray-300 font-medium text-sm transition-colors">Confirm New Password</span>}
    ...
    return (
        <div className="pt-6 md:pt-2">
            {/* Page Header */}
            <div className="mb-6">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white tracking-tight transition-colors">Settings</h2>
                <p className="text-gray-500 dark:text-gray-400 mt-1 text-sm transition-colors">Manage your profile and security preferences</p>
            </div>
            ...
            >
                <div className="text-center py-4">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Verification Email Sent</h3>
                    <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed mb-6">
                        A verification email has been sent to your new email address.
                        Please check your inbox and click the link to confirm the change.
                        You must <strong>log out now</strong> to avoid inconsistencies.
                    </p>
                    <Button
                        type="primary"
                        danger
