    ...
    return (
        <div className="w-full max-w-md mx-auto">
            ...
            <div className="text-center mb-8 flex flex-col items-center">
                ...
                <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 tracking-tight mb-2 transition-colors">Forgot Password?</h2>
                <p className="text-gray-500 dark:text-gray-400 text-base px-2 transition-colors">Enter your email and we'll send you a link to reset your password.</p>
            </div>
                ...
                >
                    ...
                    >
                        <Input
                            ...
                            prefix={<MailOutlined className="text-gray-400 dark:text-gray-500 mr-2" />}
                        />
                    </Form.Item>
