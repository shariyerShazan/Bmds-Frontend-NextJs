    ...
    return (
        <div className="w-full max-w-md mx-auto">
            ...
            <div className="text-center mb-8 flex flex-col items-center">
                ...
                <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 tracking-tight mb-2 transition-colors">Set New Password</h2>
                <p className="text-gray-500 dark:text-gray-400 text-base px-2 transition-colors">Please create a strong password to secure your account.</p>
            </div>
