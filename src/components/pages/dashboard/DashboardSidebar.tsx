    ...
    () => [
      {
        ...
        label: (
          <Link href="/dashboard/overview" className="font-semibold">
            Dashboard
          </Link>
        ),
      },
      {
        ...
        label: (
          <Link href="/dashboard/categories" className="font-semibold">
            Categories
          </Link>
        ),
      },
      {
        ...
        label: (
          <Link href="/dashboard/brands" className="font-semibold">
            Brands
          </Link>
        ),
      },
      {
        ...
        label: (
          <Link href="/dashboard/products" className="font-semibold">
            Products
          </Link>
        ),
      },
      {
        ...
        label: (
          <Link href="/dashboard/reports" className="font-semibold">
            Reports
          </Link>
        ),
      },
...
const handleLogout = useCallback(async () => {
  ...
  const containerClasses = useMemo(
    () =>
      `bg-white dark:bg-[#141414] h-full transition-all duration-300 z-50 border-r border-gray-100/80 dark:border-white/10 ${
        isMobile
  ...
  return (
    <div className={containerClasses}>
      ...
      <div className="flex items-center justify-center relative mb-4">
        <div
          className={`flex items-center ${collapsed ? "p-3" : "p-6 pb-2"} gap-3 w-full ${collapsed ? "justify-center" : "justify-start"}`}
        >
