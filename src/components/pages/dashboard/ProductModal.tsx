    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4">
          ...
          >
            <Input placeholder="e.g. iPhone 16 Pro" className={inputClasses} />
          </Form.Item>
          ...
          >
            <Input placeholder="e.g. A3102" className={inputClasses} />
          </Form.Item>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4">
          ...
          <Form.Item
            ...
            name="barCode"
          >
            <Input placeholder="e.g. 1234567890123" className={inputClasses} />
          </Form.Item>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4">
          ...
          >
            <Select
              ...
              notFoundContent={
                isBrandsLoading ? "Loading..." : "No brands found"
              }
              className="!rounded-xl"
              size="large"
            />
