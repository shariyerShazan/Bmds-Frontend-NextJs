...
export default function EditReportModal({ open, editingReport, onClose }: EditReportModalProps) {
        ...
        >
            ...
            <div className="bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 rounded-xl p-3 mb-4">
                <p className="text-amber-800 dark:text-amber-400 text-sm font-medium flex items-center gap-2">
                    <WarningOutlined /> Only use this to correct a quantity mistake. This will recalculate profit/loss and affect overall reports.
                </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-[#1a1a1a] rounded-xl px-4 py-3 mb-4 border border-gray-100 dark:border-[#303030]">
                <div className="flex items-center justify-between">
                    <div>
                        <div className="text-xs text-gray-500 dark:text-gray-400 font-medium uppercase tracking-wider mb-1">Product</div>
            ...
            >
                ...
                <Form.Item
                    ...
                    name="qty"
                    rules={[{ required: true, message: 'Please enter the corrected quantity' }]}
                >
                    <InputNumber
                        placeholder="e.g. 5"
                        min={0}
