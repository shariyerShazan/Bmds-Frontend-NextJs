  ...
  return (
    ...
    >
        ...
        <div className="bg-gray-50 dark:bg-[#1a1a1a] rounded-xl p-4 mb-6 border border-gray-100 dark:border-[#303030] transition-colors">
          ...
          <div className="flex items-center gap-3 text-sm text-gray-500 dark:text-gray-400">
            ...
            <span>
              Current Stock{" "}
              <strong
                className={`font-semibold ${product.initStock > 0 ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400"}`}
              >
                {product.initStock}
              </strong>
            </span>
      ...
      >
        <Form.Item
          label={
            <span className={`${labelClasses} text-sm mb-1 block`}>
              Action Type
            </span>
          }
          name="type"
          ...
          >
            ...
            >
              <div className="flex items-center gap-2">
                <ArrowDownOutlined
                  className={`text-sm transition-transform duration-300 ${typeValue === "IN" ? "translate-y-0.5" : ""}`}
                />
                Stock In
              </div>
            </Radio.Button>
            ...
            >
              <div className="flex items-center gap-2">
                <ArrowUpOutlined
                  className={`text-sm transition-transform duration-300 ${typeValue === "OUT" ? "-translate-y-0.5" : ""}`}
                />
                Stock Out
              </div>
            </Radio.Button>
