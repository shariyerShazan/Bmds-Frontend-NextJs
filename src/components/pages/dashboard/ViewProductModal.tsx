      ...
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-gray-50 dark:bg-[#1a1a1a] rounded-xl p-3.5 border border-gray-100 dark:border-[#303030] transition-colors">
            <p className="text-[11px] uppercase tracking-wider text-gray-400 dark:text-gray-500 font-semibold mb-1 transition-colors">
              Cost Price
            </p>
            <p className="text-base font-bold text-gray-900 dark:text-white transition-colors">
        ...
        {product.description && (
          <div>
            <p className="text-xs uppercase tracking-wider text-gray-400 dark:text-gray-500 font-semibold mb-1.5 transition-colors">
              Description
            </p>
...
function DetailRow({
  ...
  return (
    <div className="flex items-center justify-between px-4 py-3">
      ...
      <span
        className={`text-sm font-medium text-gray-900 dark:text-white transition-colors ${mono ? "font-mono" : ""}`}
      >
        {value}
      </span>
    </div>
